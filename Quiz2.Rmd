...
```{r}
if (!"q2_5_data.for" %in% dir("./")) {
    fileUrl1 <- "https://d396qusza40orc.cloudfront.net/getdata%2Fwksst8110.for"
    download.file(url=fileUrl1, destfile="q2_5_data.for", mode="w", method="curl")
}

q2.5.data <- read.fwf("q2_5_data.for",widths=c(-1,9,-5,4,4,-5,4,4,-5,4,4,-5,4,4), skip=4)
sum(q2.5.data[, 4])
```